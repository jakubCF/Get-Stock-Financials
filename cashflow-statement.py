...
if __name__ == "__main__":
    ...
    # link "http://financials.morningstar.com/cash-flow/cf.html?t=AAPL&region=NYSE&culture=en_US"
    ...
    link = "http://financials.morningstar.com/cash-flow/cf.html?t=" + symbol
